  ...
  implements State
{
  ...
  public Object      setAttribute(String name, Object value) throws RemoteException {return getState().setAttribute(name, value);}
  public Object      removeAttribute(String name)            throws RemoteException {return getState().removeAttribute(name);}
  ...
  public String toString() {return "<"+getClass()+"->"+_state+">";}
