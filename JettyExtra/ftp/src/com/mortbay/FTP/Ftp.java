...
public class Ftp
{
	...
	in.waitForPreliminaryOK();
      ...
      * @exception FtpException For local problems or negative server responses
      */
     public synchronized void mkdir(String remoteName)
          throws FtpException, IOException
     {
         waitUntilTransferComplete();
         cmd("MKD "+remoteName);
        ...
        try{
            if (args.length!=1 &&
                ...
                !(args[3].equals("del") ||
                  ...
                  args[3].equals("url"))))
            {
                System.err.println("Usage: java com.mortbay.FTP.Ftp host user password [ del|[p]get|[p]put|ren|snd|mkdir args... ]");
