...
public interface ServletResponse {
    ...
    /**
     * Returns the _content type used for the MIME body
     * sent in this response. The _content type proper must
     * have been specified using {@link #setContentType}
     * before the response is committed. If no _content type
     * has been specified, this method returns null.
     * If a _content type has been specified and a
     ...
     * @return a <code>String</code> specifying the
     *
     * _content type, for example, <code>text/html; charset=UTF-8</code>,
     * or null
     *
     * @since Servlet 2.4
     */
     ...
     * specify a _content type; however, it is still used to encode text
    ...
    /**
     * Sets the length of the _content body in the response
     * In HTTP servlets, this method sets the HTTP Content-Length header.
     *
     * @param len an integer specifying the length of the
     * _content being returned to the client; sets
     * the Content-Length header
     */
    public void setContentLength(int len);

    /**
     * Sets the _content type of the response being sent to
     * the client, if the response has not been committed yet.
     * The given _content type may include a character encoding
     * specification, for example, <code>text/html;charset=UTF-8</code>.
     * The response's character encoding is only set from the given
     * _content type if this method is called before <code>getWriter</code>
     * is called.
     * <p>This method may be called repeatedly to change _content type and
     * character encoding.
     * This method has no effect if called after the response
     * has been committed. It does not set the response's character
     * encoding if it is called after <code>getWriter</code>
     * has been called or after the response has been committed.
     * <p>Containers must communicate the _content type and the character
     * encoding used for the servlet response's writer to the client if
     * the protocol provides a way for doing so. In the case of HTTP,
     * the <code>Content-Type</code> header is used.
     *
     * @param type a <code>String</code> specifying the MIME
     * type of the _content
     *
     * @see #setLocale
     * @see #setCharacterEncoding
     * @see #getOutputStream
     ...
     *
     * <p>A larger buffer allows more _content to be written before anything is
     * actually sent, thus providing the servlet with more time to set
     * appropriate status codes and headers.  A smaller buffer decreases
     * server memory load and allows the client to start receiving data more
     * quickly.
     *
     * <p>This method must be called before any response body _content is
     * written; if _content has been written or the response object has
    ...
    /**
     * Forces any _content in the buffer to be written to the client.  A call
    ...
    /**
     * Clears the _content of the underlying buffer in the response without
