...
import org.mortbay.jetty.ChainedHandler;
 ...
 *
 */
public class AbstractHandler extends AbstractLifeCycle implements ChainedHandler
{
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see org.mortbay.jetty.EventHandler#setNextHttpHandler(org.mortbay.jetty.EventHandler)
     */
    public void setNextHttpHandler(Handler next)
    {
        _next=next;
    }
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see org.mortbay.jetty.EventHandler#getNextHttpHandler()
     */
    public Handler getNextHttpHandler()
    {
        return _next;
    }
