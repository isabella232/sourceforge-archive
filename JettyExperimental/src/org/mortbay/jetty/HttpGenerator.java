...
public class HttpGenerator implements HttpTokens
{
    	...
    	throws IOException
    {
        ...
        switch(_version)
        {
            ...
            {   
                ...
                // Calculate how to end _content and connection, _content length and transfer encoding settings.
                // From RFC 2616 4.4:
                ...
                switch((int)_contentLength)
                {
                    case UNKNOWN_CONTENT:
                        // It may be that we have no _content, or perhaps _content just has not been written yet?
    	...
    	throws IOException
    {
        if (!isCommitted())
        {
            ...
            _close=close;
            if (content!=null)
                addContent(new ByteArrayBuffer(content),HttpGenerator.LAST);
            complete();
        }        
    }
}
