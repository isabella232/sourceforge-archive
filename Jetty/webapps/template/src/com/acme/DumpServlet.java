...
public class DumpServlet extends HttpServlet
{
    ...
    {
        // ===================================================================
        // Modify the section below to calculate url, servlet and info below
        // ===================================================================
...
//         PrintWriter out= response.getWriter();
    String furi =(String)request.getAttribute  
    ("javax.servlet.forward.request_uri");
    if (furi==null) furi=request.getRequestURI();
    String url=request.getScheme()+"://"+
    request.getServerName()+":"+request.getServerPort()+furi;

    String uri=(String)request.getAttribute
    ("javax.servlet.forward.request_uri");
    if (uri==null) uri=request.getRequestURI();

    String servlet=(String)request.getAttribute  
    ("javax.servlet.include.servlet_path");
    if (servlet==null) servlet=request.getServletPath();

    String info =(String)request.getAttribute
