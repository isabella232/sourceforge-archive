...
{    
        ...
        throws IOException
    {
        ...
        HttpConnection connection = new HttpConnection(null,in,out);
    ...
    {
        Test test = new Test("com.mortbay.HTTP.HttpRequest.getRequestLine");
    ...
    {        
        Test t = new Test("com.mortbay.HTTP.HttpRequest.getParameter");
        try
        {
