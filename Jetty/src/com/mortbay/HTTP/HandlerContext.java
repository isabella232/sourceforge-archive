...
public class HandlerContext implements LifeCycle
{
    ...
    public synchronized Map getMimeMap()
    {
        if (_mimeMap==null)
        {
            ...
            _mimeMap.put("class","application/java-vm");
            ...
            _mimeMap.put("gz","application/gzip");
            _mimeMap.put("gzip","application/gzip");
            ...
            _mimeMap.put("tar.gz","application/x-gtar");
            ...
            _mimeMap.put("tgz","application/x-gtar");
            ...
            _mimeMap.put("z","application/compress");
        }
        return _mimeMap;
    }
