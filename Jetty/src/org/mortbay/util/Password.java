 ...
 * a secure way to store passwords that only need to be checked rather
 * than recovered.
 *
...
public class Password
{
	...
	{
            String cryptVal = _cs.substring("CRYPT:".length());
            return cryptVal.equals(UnixCrypt.crypt(passwd,cryptVal));
	}
