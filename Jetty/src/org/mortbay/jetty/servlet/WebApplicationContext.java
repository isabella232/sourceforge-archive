...
public class WebApplicationContext extends ServletHttpContext implements Externalizable
{
    ...
    public void start() throws Exception
    {
        ...
        try
        {
            ...
            URL webservice11xsd=
                WebApplicationContext.class.getResource("/javax/servlet/resources/j2ee_web_services_client_1_1.xsd");
    ...
    protected void initSecurityConstraint(XmlParser.Node node)
    {
        ...
        if (data != null)
        {
            ...
            if (guarantee == null || guarantee.length() == 0 || "NONE".equals(guarantee))
                ...
                if ("INTEGRAL".equals(guarantee))
                    scBase.setDataConstraint(SecurityConstraint.DC_INTEGRAL);
                else
                    if ("CONFIDENTIAL".equals(guarantee))
    ...
    protected void initLoginConfig(XmlParser.Node node)
    {
        ...
        if (method != null)
        {
            ...
            if (SecurityConstraint.__FORM_AUTH.equals(m))
                ...
                if (SecurityConstraint.__BASIC_AUTH.equals(m))
                    authenticator= new BasicAuthenticator();
                else
                    if (SecurityConstraint.__DIGEST_AUTH.equals(m))
                        authenticator= new DigestAuthenticator();
                    else
                        if (SecurityConstraint.__CERT_AUTH.equals(m))
                            authenticator= new ClientCertAuthenticator();
                        else
                            if (SecurityConstraint.__CERT_AUTH2.equals(m))
                                authenticator= new ClientCertAuthenticator();
                            else
