...
public class TestHarness
{
    ...
    static
    {
        try{
            ...
            if (!__userURL.toString().endsWith("/XML/"))
            {
                ...
                __relDir="src/org/mortbay/xml/".replace('/',
                                                         File.separatorChar);
            }                
        }
        catch(Exception e)
    ...
    {
        Test t = new Test("org.mortbay.xml.XmlParser");
        try
        {
    ...
    {
        Test t = new Test("org.mortbay.xml.XmlConfiguration");
        try
        {
            String url = __userURL+"TestData/configure.xml";
    ...
    public static void main(String[] args)
    {
        ...
        {
            Code.warning(th);
            Test t = new Test("org.mortbay.xml.TestHarness");
