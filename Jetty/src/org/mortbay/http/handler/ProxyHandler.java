...
public class ProxyHandler extends AbstractHttpHandler
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * Map of leg by leg headers (not end to end). Should be a set, but more efficient string map
     * is used instead.
     */
     ...
     * tunnel connection. / public void setTunnelTimeoutMs(int ms) { _tunnelTimeoutMs = ms; }
     * ------------------------------------------------------------
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * Customize proxy URL connection. Method to allow derived handlers to customize the
     * connection.
     */
