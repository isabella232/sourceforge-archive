 ...
 * 
 * @version $Id: AJP13Listener.java,v 1.14.2.1 2003/10/16 06:45:26 gregwilkins
 *          Exp $
...
public class AJP13Listener extends ThreadedServer implements HttpListener
{
    ...
    {
        Code.assertTrue(_server==null||_server==server,"Cannot share listeners");
        _server=server;
    }
    ...
    public void start() throws Exception
    {
        ...
        Log.event("NOTICE: AJP13 is not a secure protocol. Please protect the port "+getInetAddrPort());
    }
