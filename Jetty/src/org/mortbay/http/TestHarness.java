...
public class TestHarness
{
    ...
    public static void chunkInTest()
        throws Exception
    {
        Test test = new Test("org.mortbay.http.ChunkableInputStream");
    ...
    public static void chunkOutTest()
        throws Exception
    {
        Test test = new Test("org.mortbay.http.ChunkableOutputStream");
    ...
    {
        Test t = new Test("org.mortbay.http.ChunkableXxxputStream");
        try
        {
        ...
        throws IOException
    {
        ...
        Test t = new Test("org.mortbay.http.HttpFields");
        try
        {    
    ...
    {
        Test t = new Test("org.mortbay.http.PathMap");
        try
        {
    ...
    public static void main(String[] args)
    {
        ...
        {
            Code.warning(e);
            new Test("org.mortbay.http.TestHarness").check(false,e.toString());
        }
        finally
        {
            Test.report();
