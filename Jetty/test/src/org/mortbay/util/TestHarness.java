...
//             System.err.println("User URL="+__userURL);
    ...
    {
        TestCase t = new TestCase("org.mortbay.util.Password");
        try{
    ...
    {
        TestCase test = new TestCase("org.mortbay.util.URI");
        try
        {
            URI uri;
    ...
    {
        TestCase t = new TestCase("org.mortbay.util.Resource");
        try
        {
            Resource r;
            ...
            // Test HTTP Resource
            // XXX deleted stupid test!!!! need to do something!
